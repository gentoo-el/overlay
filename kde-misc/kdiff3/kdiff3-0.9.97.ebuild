...
# $Header: /var/cvsroot/gentoo-x86/kde-misc/kdiff3/kdiff3-0.9.97.ebuild,v 1.1 2012/08/15 11:03:41 johu Exp $
...
PATCHES=(
	"${FILESDIR}/${P}-fix_merge.0.patch"
	"${FILESDIR}/${P}-fix_merge.1.patch"
)
